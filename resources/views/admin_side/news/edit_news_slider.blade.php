    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0 align-items-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit News Slider</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="ms-auto">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5>Add News Slider</h5>
                        <form action="{{ url('update-news-slider') }}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="news_slider_id" value="{{ $news_slider->id }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc" class="form-control" rows="4">{{ $news_slider->desc }}</textarea>
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('storage/app/public/uploads/news/slider/' . $news_slider->image) }}"
