                         ...
                         <div class="ps-3">
                             <nav aria-label="breadcrumb">
                                 <ol class="breadcrumb mb-0 p-0 align-items-center">
                                     ...
                                     <li class="breadcrumb-item active" aria-current="page">Add Blog Slider</li>
                                 </ol>
                             </nav>
                         </div>
                         <div class="ms-auto">
                             <div class="btn-group">
                                 <a href="{{ url('blog/slider') }}" class="btn btn-outline-primary">Back</a>
                             </div>
                         </div>
                     </div>
                 </div>
             ...
             <div class="row">
                 ...
                 <div class="card">
                     <div class="card-body">
                         ...
                         <form action="{{ url('store_blog_slider') }}" method="POST" enctype="multipart/form-data">
                             @csrf
                             <div class="row">
                                 <div class="col-md-12">
